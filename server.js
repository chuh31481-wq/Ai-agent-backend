...
// Intehai tafseeli tool config taake AI ghalti na kare
const toolConfig = {
    functionDeclarations: [
        {
            name: "createDirectory",
            description: "Creates a new, empty directory. Use this to create project folders.",
            parameters: { type: "object", properties: { directoryName: { type: "string", description: "The path and name of the directory to create, e.g., 'my-project/css'." } }, required: ["directoryName"] }
        },
        {
            name: "createFile",
            description: "Creates a new file with specified content. Use this for all file creation.",
        ...
        },
        {
            ...
            description: "Creates a new public GitHub repository on the user's account.",
